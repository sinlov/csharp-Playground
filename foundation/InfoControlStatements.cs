...
{
    public class InfoControlStatements : Koan
    {
        [Koan(1)]
        ...
        {
            bool isKoan = false;
            bool isInfoControlStatements = false;
            bool isInfoMethods = false;
            ...
            if (myType is InfoControlStatements)
                isInfoControlStatements = true;
