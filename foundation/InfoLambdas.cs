...
namespace foundation
{
    public class InfoLambdas : Koan
    {
        ...
        public void UsingAnonymousMethods()
        {
            ...
            var result = Array.ConvertAll(numbers, delegate(int x) { return x.ToString(); });
        ...
        public void AnonymousMethodsCanAccessOuterVariables()
        {
            ...
            int toFind = 7;
            Assert.Equal(3, Array.FindIndex(numbers, delegate(int x) { return x == toFind; }));
        }
        ...
        public void AccessEvenAfterVariableIsOutOfScope()
        {
            Predicate<int> criteria;
            {
                ...
                int toFind = 7;
                criteria = delegate(int x) { return x == toFind; };
            }
            var numbers = new[] {4, 5, 6, 7, 8, 9};
        ...
        {
            var numbers = new[] {1, 2, 3, 4};
            var anonymous = Array.ConvertAll(numbers, delegate(int x) { return x.ToString(); });
            ...
            //        |----------------------------|        |
            //                                    \|/      \|/
            var lambda = Array.ConvertAll(numbers, (int x) => { return x.ToString(); });
